...
class PaperRepository:
    ...
    def get_processing_stats(self) -> dict:
        ...
        text_stmt = select(func.count(Paper.id)).where(Paper.raw_text.is_(None))
        ...
        return {
            ...
            "processing_rate": (
                (processed_papers / total_papers * 100) if total_papers > 0 else 0
            ),
